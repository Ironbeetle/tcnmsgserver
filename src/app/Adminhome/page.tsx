...
function page(props: any) {
    ...
    return (
        <div className="w-screen h-screen bg-gray-100" style={{backgroundColor:"rgba(2, 67, 108, 0.5)"}}>           <div className="flex flex-col justify-evenly items-center h-full w-full">
